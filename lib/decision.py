...
df = pd.read_csv(r'D:\projexct\flutter projects\student_pp-main\place-main\dataset\job_details.csv')
...
try:
    course_df.to_csv(r'D:\projexct\flutter projects\student_pp-main\place-main\dataset\individual_course_frequency.csv', index=False)
